...
function element_occurrences(data) {
  ...
  // get each unique element in the dataset
  // for each unique element, count the frequency of that element
  // set the element as a key and the frequency as a value in an object
  // return the object
