...
const countNumbersBetween = require('../lib/countBetween')

it('returns zero if array is empty', function(){
  assert.equal(countNumbersBetween([], -10, 10), 0)
})

it('returns expected count of numbers between bounds', function(){
